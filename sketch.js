...
//Llamar funciones para detener la colision para el jugador y la computadora
...
function keyPressed() {
  ...
  if(keyCode === 32){
    //crea un objeto de flecha y agregala en una matriz ; establece su ángulo igual que el de playerArcher
